...
class CategoryGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, hidden, deleted, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, hidden, deleted, *args, **kwargs):  # noqa: E501
        """CategoryGroup - a model defined in OpenAPI
