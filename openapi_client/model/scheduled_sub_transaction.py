...
class ScheduledSubTransaction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, scheduled_transaction_id, amount, deleted, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, scheduled_transaction_id, amount, deleted, *args, **kwargs):  # noqa: E501
        """ScheduledSubTransaction - a model defined in OpenAPI
