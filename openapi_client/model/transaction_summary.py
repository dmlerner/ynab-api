...
class TransactionSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, date, amount, cleared, approved, account_id, deleted, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, date, amount, cleared, approved, account_id, deleted, *args, **kwargs):  # noqa: E501
        """TransactionSummary - a model defined in OpenAPI
