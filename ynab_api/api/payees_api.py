...
class PayeesApi(object):
    ...
    def get_payee_by_id(self, budget_id, payee_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_payee_by_id_with_http_info(budget_id, payee_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_payee_by_id_with_http_info(self, budget_id, payee_id, **kwargs):  # noqa: E501
        ...
        if ('budget_id' not in params or
            ...
            raise ValueError("Missing the required parameter `budget_id` when calling `get_payee_by_id`")  # noqa: E501
        # verify the required parameter 'payee_id' is set
        if ('payee_id' not in params or
                params['payee_id'] is None):
            raise ValueError("Missing the required parameter `payee_id` when calling `get_payee_by_id`")  # noqa: E501
    ...
    def get_payees(self, budget_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_payees_with_http_info(budget_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_payees_with_http_info(self, budget_id, **kwargs):  # noqa: E501
        ...
        if ('budget_id' not in params or
                params['budget_id'] is None):
            raise ValueError("Missing the required parameter `budget_id` when calling `get_payees`")  # noqa: E501
