...
class ScheduledTransactionDetail(object):
    ...
    def __init__(self, id=None, date_first=None, date_next=None, frequency=None, amount=None, memo=None, flag_color=None, account_id=None, payee_id=None, category_id=None, transfer_account_id=None, deleted=None, account_name=None, payee_name=None, category_name=None, subtransactions=None, local_vars_configuration=None):  # noqa: E501
