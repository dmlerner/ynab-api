...
class ScheduledTransactionDetail(ScheduledTransactionSummary):
    ...
    if hasattr(ScheduledTransactionSummary, "swagger_types"):
        swagger_types.update(ScheduledTransactionSummary.swagger_types)
    ...
    if hasattr(ScheduledTransactionSummary, "attribute_map"):
        attribute_map.update(ScheduledTransactionSummary.attribute_map)
    ...
    def __init__(self, account_name=None, payee_name=None, category_name=None, subtransactions=None, *args, **kwargs):  # noqa: E501
        ...
        ScheduledTransactionSummary.__init__(self, *args, **kwargs)
