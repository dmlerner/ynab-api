...
class CategoryGroupWithCategoriesAllOf(object):
    ...
    @property
    def categories(self):
        """Gets the categories of this CategoryGroupWithCategoriesAllOf.  # noqa: E501

        Category group categories.  Amounts (budgeted, activity, balance, etc.) are specific to the current budget month (UTC).  # noqa: E501

        :return: The categories of this CategoryGroupWithCategoriesAllOf.  # noqa: E501
        :rtype: list[Category]
        """
    ...
    def categories(self, categories):
        """Sets the categories of this CategoryGroupWithCategoriesAllOf.

        Category group categories.  Amounts (budgeted, activity, balance, etc.) are specific to the current budget month (UTC).  # noqa: E501

        :param categories: The categories of this CategoryGroupWithCategoriesAllOf.  # noqa: E501
        :type: list[Category]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoryGroupWithCategoriesAllOf):
            return False
