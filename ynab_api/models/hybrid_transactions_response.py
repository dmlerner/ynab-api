...
class HybridTransactionsResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """HybridTransactionsResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this HybridTransactionsResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this HybridTransactionsResponse.
