...
class MonthSummariesResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """MonthSummariesResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this MonthSummariesResponse.  # noqa: E501


        :return: The data of this MonthSummariesResponse.  # noqa: E501
        :rtype: MonthSummariesResponseData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this MonthSummariesResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MonthSummariesResponse):
            return False
