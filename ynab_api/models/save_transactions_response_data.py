...
class SaveTransactionsResponseData(object):
    ...
    def __init__(self, transaction_ids=None, transaction=None, transactions=None, duplicate_import_ids=None, server_knowledge=None, local_vars_configuration=None):  # noqa: E501
