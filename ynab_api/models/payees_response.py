...
class PayeesResponse(object):
    ...
    @property
    def data(self):
        """Gets the data of this PayeesResponse.  # noqa: E501


        :return: The data of this PayeesResponse.  # noqa: E501
        :rtype: PayeesResponseData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PayeesResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayeesResponse):
            return False
