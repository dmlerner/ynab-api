...
class TransactionsImportResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """TransactionsImportResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this TransactionsImportResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this TransactionsImportResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransactionsImportResponse):
            return False
