...
class HybridTransactionsResponseData(object):
    ...
    def transactions(self):
        """Gets the transactions of this HybridTransactionsResponseData.  # noqa: E501


        :return: The transactions of this HybridTransactionsResponseData.  # noqa: E501
        :rtype: list[HybridTransaction]
        """
        return self._transactions

    @transactions.setter
    def transactions(self, transactions):
        """Sets the transactions of this HybridTransactionsResponseData.


        :param transactions: The transactions of this HybridTransactionsResponseData.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HybridTransactionsResponseData):
            return False
