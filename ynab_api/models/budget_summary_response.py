...
class BudgetSummaryResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """BudgetSummaryResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this BudgetSummaryResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BudgetSummaryResponse):
            return False
