...
class PayeeLocationsResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """PayeeLocationsResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this PayeeLocationsResponse.  # noqa: E501


        :return: The data of this PayeeLocationsResponse.  # noqa: E501
        :rtype: PayeeLocationsResponseData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PayeeLocationsResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayeeLocationsResponse):
            return False
