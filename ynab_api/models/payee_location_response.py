...
class PayeeLocationResponse(object):
    ...
    @property
    def data(self):
        """Gets the data of this PayeeLocationResponse.  # noqa: E501


        :return: The data of this PayeeLocationResponse.  # noqa: E501
        :rtype: PayeeLocationResponseData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PayeeLocationResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayeeLocationResponse):
            return False
