...
import six
from ynab_api.models.month_summary import MonthSummary  # noqa: F401,E501
...
class MonthDetail(MonthSummary):
    ...
    if hasattr(MonthSummary, "swagger_types"):
        swagger_types.update(MonthSummary.swagger_types)

    attribute_map = {
        'categories': 'categories'
    }
    if hasattr(MonthSummary, "attribute_map"):
        attribute_map.update(MonthSummary.attribute_map)
    ...
    def __init__(self, categories=None, *args, **kwargs):  # noqa: E501
        ...
        MonthSummary.__init__(self, *args, **kwargs)
