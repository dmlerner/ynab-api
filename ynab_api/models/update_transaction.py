...
class UpdateTransaction(object):
    ...
    @property
    def id(self):
        """Gets the id of this UpdateTransaction.  # noqa: E501


        :return: The id of this UpdateTransaction.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UpdateTransaction.


        :param id: The id of this UpdateTransaction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def date(self):
        """Gets the date of this UpdateTransaction.  # noqa: E501
        ...
        :return: The date of this UpdateTransaction.  # noqa: E501
        :rtype: date
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this UpdateTransaction.

        The transaction date in ISO format (e.g. 2016-12-01).  Future dates (scheduled transactions) are not permitted.  Split transaction dates cannot be changed and if a different date is supplied it will be ignored.  # noqa: E501

        :param date: The date of this UpdateTransaction.  # noqa: E501
        :type: date
        """
