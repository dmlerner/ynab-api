...
def lazy_import():
    ...
    globals()['BulkResponseDataBulk'] = BulkResponseDataBulk


class BulkResponseData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'bulk': (BulkResponseDataBulk,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, bulk, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, bulk, *args, **kwargs):  # noqa: E501
        """BulkResponseData - a model defined in OpenAPI
