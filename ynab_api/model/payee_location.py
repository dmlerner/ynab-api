...
class PayeeLocation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, payee_id, latitude, longitude, deleted, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, payee_id, latitude, longitude, deleted, *args, **kwargs):  # noqa: E501
        """PayeeLocation - a model defined in OpenAPI
