...
class Category(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'category_group_name': (str,),  # noqa: E501
            'original_category_group_id': (str,),  # noqa: E501
            'note': (str, none_type,),  # noqa: E501
            'goal_type': (str,),  # noqa: E501
            'goal_day': (int,),  # noqa: E501
            'goal_cadence': (int,),  # noqa: E501
            'goal_cadence_frequency': (int,),  # noqa: E501
    ...
    def _from_openapi_data(cls, id, category_group_id, name, hidden, budgeted, activity, balance, deleted, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            category_group_name (str): [optional]  # noqa: E501
            original_category_group_id (str): DEPRECATED: No longer used.  Value will always be null.. [optional]  # noqa: E501
            ...
            goal_day (int): A day offset modifier for the goal's due date. When goal_cadence is 2 (Weekly), this value specifies which day of the week the goal is due (0 = Sunday, 6 = Saturday). Otherwise, this value specifies which day of the month the goal is due (1 = 1st, 31 = 31st, null = Last day of Month).. [optional]  # noqa: E501
