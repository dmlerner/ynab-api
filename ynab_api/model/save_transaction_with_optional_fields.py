...
class SaveTransactionWithOptionalFields(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cleared': (str, none_type,),  # noqa: E501
            'approved': (bool, none_type,),  # noqa: E501
            'flag_color': (str, none_type,),  # noqa: E501
            'import_id': (str, none_type,),  # noqa: E501
            'subtransactions': ([SaveSubTransaction], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SaveTransactionWithOptionalFields - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            date (date, none_type): The transaction date in ISO format (e.g. 2016-12-01).  Future dates (scheduled transactions) are not permitted.  Split transaction dates cannot be changed and if a different date is supplied it will be ignored.. [optional]  # noqa: E501
            amount (int, none_type): The transaction amount in milliunits format.  Split transaction amounts cannot be changed and if a different amount is supplied it will be ignored.. [optional]  # noqa: E501
            ...
            approved (bool, none_type): Whether or not the transaction is approved.  If not supplied, transaction will be unapproved by default.. [optional]  # noqa: E501
            ...
            subtransactions ([SaveSubTransaction], none_type): An array of subtransactions to configure a transaction as a split.  Updating `subtransactions` on an existing split transaction is not supported.. [optional]  # noqa: E501
        """
