...
class ScheduledTransactionDetailAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_name, subtransactions, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            category_name (str): The name of the category.  If a split scheduled transaction, this will be 'Split'.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_name, subtransactions, *args, **kwargs):  # noqa: E501
        """ScheduledTransactionDetailAllOf - a model defined in OpenAPI
