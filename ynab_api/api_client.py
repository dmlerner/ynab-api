...
from ynab_api import rest
from ynab_api.configuration import Configuration
from ynab_api.exceptions import ApiTypeError, ApiValueError, ApiException
from ynab_api.model_utils import (ModelNormal, ModelSimple, ModelComposed,
                                  check_allowed_values, check_validations,
                                  date, datetime, deserialize_file, file_type,
                                  model_to_dict, none_type,
...
class ApiClient(object):
    ...
    def __call_api(
            ...
            query_params: typing.Optional[typing.List[typing.Tuple[
                str, typing.Any]]] = None,
            header_params: typing.Optional[typing.Dict[str,
                                                       typing.Any]] = None,
            body: typing.Optional[typing.Any] = None,
            post_params: typing.Optional[typing.List[typing.Tuple[
                str, typing.Any]]] = None,
            ...
            _request_timeout: typing.Optional[typing.Union[
                int, float, typing.Tuple]] = None,
    ...
    def call_api(
        ...
        if not async_req:
            return self.__call_api(resource_path, method, path_params,
                                   ...
                                   _request_timeout, _host, _check_type)
...
class Endpoint(object):
    ...
    def __init__(self,
        ...
        self.params_map['all'].extend([
            'async_req', '_host_index', '_preload_content', '_request_timeout',
            '_return_http_data_only', '_check_input_type', '_check_return_type'
        ])
        ...
        extra_types = {
            ...
            '_request_timeout':
            (none_type, float, (float, ), [float], int, (int, ), [int]),
        ...
        for param_name, param_value in kwargs.items():
            ...
            if param_location:
                ...
                if (param_location == 'form'
                        and self.openapi_types[param_name] == (file_type, )):
